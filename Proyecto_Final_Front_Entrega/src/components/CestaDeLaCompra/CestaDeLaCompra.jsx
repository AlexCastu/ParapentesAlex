...
const CestaDeLaCompra = () => {
  ...
  const comprobarProductosEnLaCesta = () => {
    axios
      .get(
        `https://proyectofinalback-production.up.railway.app/tienda/verLaCesta`
      )
      .then((response) => {
    ...
    return (
      <>
            ...
            {sinProductos ? (
              ...
              <>
                <div className="cestaVacia">
                  <p>UPS...</p>
                  <p>
                    Todavia no tienes nada en la cesta, date una vuelta por
                    nuestra tienda online y seguro pronto llenaras la cesta!
                  </p>
                </div>
              </>
            )}
        ...
        <Modal show={show} onHide={handleClose}>
          ...
          <Modal.Body>
            Seras redirigido a una plataforma segura para realizar el pago.
          </Modal.Body>
          <Modal.Footer>
